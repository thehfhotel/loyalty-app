...
export class SurveyController {
  ...
  async updateSurvey(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to update survey', error: errorMessage });
    }
  }
  ...
  async deleteSurvey(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to delete survey', error: errorMessage });
    }
  }
  ...
  async submitResponse(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to submit response', error: errorMessage });
    }
  }
  ...
  async getUserResponse(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to fetch response', error: errorMessage });
    }
  }
  ...
  async getSurveyResponses(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to fetch responses', error: errorMessage });
    }
  }
  ...
  async getPublicSurveys(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to fetch public surveys', error: errorMessage });
    }
  }
  ...
  async getInvitedSurveys(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to fetch invited surveys', error: errorMessage });
    }
  }
  ...
  async exportSurveyResponses(req: Request, res: Response): Promise<void> {
    try {
      ...
      const csvRows = responses.map(response => {
        const responseWithUser = response as unknown as Record<string, unknown>;
        const row = [
          String(responseWithUser.user_email ?? ''),
          String(responseWithUser.user_first_name ?? ''),
          String(responseWithUser.user_last_name ?? ''),
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to export responses', error: errorMessage });
    }
  }
  ...
  async sendSurveyInvitations(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to send invitations', error: errorMessage });
    }
  }
  ...
  async resendInvitation(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to resend invitation', error: errorMessage });
    }
  }
  ...
  async assignCouponToSurvey(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (errorMessage.includes('not found')) {
        ...
        res.status(500).json({ message: 'Failed to assign coupon', error: errorMessage });
      }
    }
  }
  ...
  async updateSurveyCouponAssignment(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to update assignment', error: errorMessage });
    }
  }
  ...
  async removeCouponFromSurvey(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to remove assignment', error: errorMessage });
    }
  }
  ...
  async getSurveyRewardHistory(req: Request, res: Response): Promise<void> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      res.status(500).json({ message: 'Failed to fetch reward history', error: errorMessage });
    }
  }
