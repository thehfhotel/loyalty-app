    ...
    if (!surveyService.validateAnswer(question, answer)) {
      setErrors({
        [question.id]: question.required 
          ? t('surveys.errors.required', 'This question is required')
          : t('surveys.errors.invalid', 'Please provide a valid answer')
      });
      return false;
    }
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto p-4">
          ...
          <div className="mt-4">
            ...
            >
              {t('surveys.backToList', 'Back to Surveys')}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto p-4">
          <div className="text-center py-12">
            <p className="text-gray-500">{t('surveys.notFound', 'Survey not found')}</p>
          </div>
        </div>
      </div>
    );
        ...
        {!isCompletionPage ? (
          <>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  {isLastQuestion 
                    ? t('surveys.complete', 'Complete Survey')
                    : t('surveys.next', 'Next')
                  }
                </button>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              {t('surveys.completed.title', 'Survey Completed!')}
            </h2>
            <p className="text-gray-600 mb-6">
              {t('surveys.completed.message', 'Thank you for taking the time to complete this survey. Your feedback is valuable to us.')}
            </p>
            
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <p className="text-green-800 text-sm">
                ✓ {t('surveys.completed.saved', 'Your responses have been saved successfully')}
              </p>
            </div>
