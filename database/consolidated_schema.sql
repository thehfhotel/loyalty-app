...
CREATE TABLE user_profiles (
    ...
    reception_id VARCHAR(8) UNIQUE NOT NULL, -- 8-digit format (269XXXXX) generated by TypeScript backend
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- Reception ID generation is now handled entirely in TypeScript backend
-- for better deployment consistency and reduced database complexity.
-- The reception_id_sequence table provides atomic counter functionality only.
