...
--
-- Name: update_translation_updated_at(); Type: FUNCTION; Schema: public; Owner: loyalty
--
...
ALTER FUNCTION public.update_translation_updated_at() OWNER TO loyalty;
...
--
-- Name: coupon_translations; Type: TABLE; Schema: public; Owner: loyalty
--
...
CREATE TABLE public.coupon_translations (
    ...
    CONSTRAINT coupon_translations_language_check CHECK (((language)::text = ANY ((ARRAY['th'::character varying, 'en'::character varying, 'zh-CN'::character varying])::text[])))
);


ALTER TABLE public.coupon_translations OWNER TO loyalty;
...
CREATE TABLE public.coupons (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    original_language character varying(10) DEFAULT 'th'::character varying,
    available_languages jsonb DEFAULT '["th"]'::jsonb,
    last_translated timestamp with time zone,
    translation_status character varying(20) DEFAULT 'none'::character varying,
    CONSTRAINT coupons_translation_status_check CHECK (((translation_status)::text = ANY ((ARRAY['none'::character varying, 'pending'::character varying, 'completed'::character varying, 'error'::character varying])::text[])))
);
...
CREATE TABLE public.surveys (
    ...
    CONSTRAINT surveys_translation_status_check CHECK (((translation_status)::text = ANY ((ARRAY['none'::character varying, 'pending'::character varying, 'completed'::character varying, 'error'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT check_email_or_oauth CHECK ((((email IS NOT NULL) AND ((email)::text <> ''::text)) OR ((email IS NULL) AND (oauth_provider IS NOT NULL))))
);
...
--
-- Name: survey_translations; Type: TABLE; Schema: public; Owner: loyalty
--
...
CREATE TABLE public.survey_translations (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT survey_translations_language_check CHECK (((language)::text = ANY ((ARRAY['th'::character varying, 'en'::character varying, 'zh-CN'::character varying])::text[])))
);


ALTER TABLE public.survey_translations OWNER TO loyalty;
...
--
-- Name: translation_jobs; Type: TABLE; Schema: public; Owner: loyalty
--
...
CREATE TABLE public.translation_jobs (
    ...
    provider character varying(20) DEFAULT 'azure'::character varying NOT NULL,
    error text,
    created_by uuid,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    completed_at timestamp with time zone,
    CONSTRAINT translation_jobs_entity_type_check CHECK (((entity_type)::text = ANY ((ARRAY['survey'::character varying, 'coupon'::character varying])::text[]))),
    CONSTRAINT translation_jobs_progress_check CHECK (((progress >= 0) AND (progress <= 100))),
    CONSTRAINT translation_jobs_provider_check CHECK (((provider)::text = ANY ((ARRAY['azure'::character varying, 'google'::character varying, 'libretranslate'::character varying])::text[]))),
...
ALTER TABLE public.translation_jobs OWNER TO loyalty;
...
--
-- Data for Name: coupon_translations; Type: TABLE DATA; Schema: public; Owner: loyalty
--

COPY public.coupon_translations (id, coupon_id, language, name, description, terms_and_conditions, created_at, updated_at) FROM stdin;
\.
...
COPY public.coupons (id, code, name, description, terms_and_conditions, type, value, currency, minimum_spend, maximum_discount, valid_from, valid_until, usage_limit, usage_limit_per_user, used_count, tier_restrictions, customer_segment, status, created_by, created_at, updated_at, original_language, available_languages, last_translated, translation_status) FROM stdin;
e9d238d9-62a1-48de-880c-35e184d4a2e2	TEST1753110370269	Test Coupon 1753110370269	Test coupon created for troubleshooting	\N	percentage	10.00	THB	\N	\N	2025-07-21 15:06:10.339+00	\N	100	1	0	[]	{}	expired	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-21 15:06:10.333051+00	2025-07-23 03:34:06.755694+00	th	["th"]	\N	none
c5cef2e6-cc75-49fa-bc0a-a05d8d670005	TEST528567	Translation Test Coupon	Testing coupon for translation feature	\N	percentage	10.00	USD	\N	\N	2025-07-23 16:02:08.569+00	\N	\N	1	0	[]	{}	expired	\N	2025-07-23 16:02:08.56924+00	2025-07-24 05:37:22.727295+00	th	["th"]	\N	none
6f13628f-afcc-4dcd-bf32-bb6bc390cb23	1FREE1	1แถม1	\N	\N	bogo	\N	USD	\N	\N	2025-07-21 00:00:00+00	2025-07-21 23:59:59.999+00	100	5	0	[]	{}	expired	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-21 09:24:36.026951+00	2025-07-24 22:31:09.915341+00	th	["th"]	\N	none
239b5ffd-9fff-4346-893f-3be8b7b0d5de	10FREE1	พัก 10 คืนฟรี 1 คืน	ห้องพักฟรี 1 คืน	ลูกค้าพักสะสม 10 คืน	free_service	\N	THB	\N	\N	2025-07-21 00:00:00+00	2025-12-31 23:59:59.999+00	9999	9999	0	[]	{}	expired	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-21 10:02:33.433969+00	2025-07-27 06:42:21.058837+00	th	["th"]	\N	none
063ecb4e-be48-486c-a96a-e959e70283ba	TEST520032	Translation Test Coupon	Testing coupon for translation feature	\N	percentage	10.00	USD	\N	\N	2025-07-23 16:02:00.033+00	\N	\N	1	0	[]	{}	expired	\N	2025-07-23 16:02:00.033478+00	2025-07-27 06:42:22.934392+00	th	["th"]	\N	none
856c2afa-996f-46f2-a87f-68a7d85d0840	TEST511019	Translation Test Coupon	Testing coupon for translation feature	\N	percentage	10.00	USD	\N	\N	2025-07-23 16:01:51.02+00	\N	\N	1	0	[]	{}	expired	\N	2025-07-23 16:01:51.019782+00	2025-07-27 06:42:25.566548+00	th	["th"]	\N	none
302cf891-a674-4cf6-816c-731f416daa96	TRANSLATE10	Translation Test Coupon	Testing coupon for translation feature	\N	percentage	10.00	USD	\N	\N	2025-07-23 16:01:07.774+00	\N	\N	1	0	[]	{}	expired	\N	2025-07-23 16:01:07.758207+00	2025-07-27 06:42:27.71533+00	th	["th"]	\N	none
891f5412-a810-4186-a022-285ae143cb44	TESTTTTT	testt	\N	\N	free_service	\N	USD	\N	\N	2025-07-21 00:00:00+00	2025-07-21 23:59:59.999+00	100	1	0	[]	{}	expired	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-21 06:04:11.310868+00	2025-07-21 06:22:18.211003+00	th	["th"]	\N	none
cfafbdfc-3036-48e4-8384-65356bcdb7b2	UPGRADE	Free Room Upgrade	Complimentary room upgrade	Subject to availability. Valid for Gold and Platinum members only.	free_upgrade	0.00	USD	\N	\N	2025-07-20 18:06:19.802191+00	2026-07-20 18:06:19.802191+00	100	1	0	[]	{}	expired	\N	2025-07-20 18:06:19.802191+00	2025-07-21 06:56:08.219005+00	th	["th"]	\N	none
341c57ab-9b96-4416-9dd6-d28da2b4db1d	WELCOME10	Welcome 10% Off	Get 10% off your first stay	Valid for first-time guests only. Cannot be combined with other offers.	percentage	10.00	USD	100.00	50.00	2025-07-20 18:06:19.802191+00	2026-01-20 18:06:19.802191+00	1000	1	0	[]	{}	expired	\N	2025-07-20 18:06:19.802191+00	2025-07-21 06:56:11.188979+00	th	["th"]	\N	none
...
1d14fbf8-79f3-44ed-a670-c0e6c7c83b78	TEST123	Test Coupon for Deletion	This coupon is for testing token refresh on deletion	\N	percentage	10.00	USD	\N	\N	2025-01-20 00:00:00+00	2025-12-31 23:59:59.999+00	100	1	0	[]	{}	expired	\N	2025-07-21 04:00:49.465749+00	2025-07-22 23:10:00.062949+00	th	["th"]	\N	none
9a1b807c-af0e-48dd-99a4-16a15722acb6	ACTIVATE123	Test Activation Coupon	This coupon tests the activation fix	\N	percentage	25.00	USD	\N	\N	2025-01-20 00:00:00+00	2025-12-31 23:59:59.999+00	50	1	0	[]	{}	expired	\N	2025-07-21 05:59:57.109978+00	2025-07-22 23:10:00.062949+00	th	["th"]	\N	none
729cdbe4-f4de-4851-aab1-7dde63618129	FRESH1753047080508	Fresh Test Coupon 1753047080508	Fresh coupon for testing complete workflow	\N	percentage	25.00	USD	\N	\N	2025-07-20 21:31:20.508+00	2025-08-19 21:31:20.509+00	100	3	0	[]	{}	expired	\N	2025-07-20 21:31:20.511411+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
b8b86aa4-1f56-4bdc-9858-9940c32c468b	FRESH1753044195572	Fresh Test Coupon 1753044195572	Fresh coupon for testing complete workflow	\N	percentage	25.00	USD	\N	\N	2025-07-20 20:43:15.572+00	2025-08-19 20:43:15.574+00	100	3	1	[]	{}	expired	\N	2025-07-20 20:00:28.238008+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
66d189a5-3a3f-480c-9b13-52704cfae5a2	FINAL1753041529573	Final Test Coupon	Testing complete workflow	\N	percentage	15.00	USD	\N	\N	2025-07-20 19:58:49.573+00	2025-08-19 19:58:49.574+00	100	1	0	[]	{}	expired	\N	2025-07-20 19:58:49.57597+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
47d901a7-b626-483c-bbee-c68087e25407	TEST459292	Test Coupon TEST459292	Test coupon for activation troubleshooting	\N	percentage	20.00	USD	\N	\N	2025-07-20 00:00:00+00	2025-08-19 23:59:59.999+00	100	1	0	[]	{}	expired	\N	2025-07-20 19:57:39.389938+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
f5ef310c-2bfb-48e2-ab15-ea394f4d939d	TEST865679	Test Coupon TEST865679	Test coupon for activation troubleshooting	\N	percentage	20.00	USD	\N	\N	2025-07-20 00:00:00+00	2025-08-19 23:59:59.999+00	100	1	1	[]	{}	expired	\N	2025-07-20 19:47:45.760273+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
11033d00-15be-4110-aa79-b81432e7ccae	TEST783346	Test TEST783346	Test coupon created at 7/21/2025, 2:29:43 AM	\N	percentage	15.00	USD	\N	\N	2025-07-20 00:00:00+00	2025-08-19 23:59:59.999+00	100	1	0	[]	{}	expired	\N	2025-07-20 19:29:43.949374+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
20e10a08-5dce-4148-ad31-bed6d33158e2	TEST763484	Test TEST763484	Test coupon created at 7/21/2025, 2:29:23 AM	\N	percentage	15.00	USD	\N	\N	2025-07-20 00:00:00+00	2025-08-19 23:59:59.999+00	100	1	0	[]	{}	expired	\N	2025-07-20 19:29:24.103643+00	2025-07-22 23:10:31.929806+00	th	["th"]	\N	none
c5f43d2c-fbd6-43ea-8e17-9572218c3508	SAVE20	20% ส่วนลด	ส่วนลด 20% สำหรับการใช้งานครั้งต่อไป	ไม่สามารถใช้ร่วมกับโปรโมชั่นอื่นได้	percentage	20.00	THB	100.00	500.00	2025-07-21 10:52:22.017+00	2025-10-19 10:52:22.017+00	1000	3	0	[]	{}	expired	\N	2025-07-21 10:52:22.016547+00	2025-07-27 06:42:18.284691+00	th	["th"]	\N	none
\.
...
1	26	2025-07-24 05:03:46.91677+00	2025-07-26 14:56:29.407339+00
\.
...
b2911aaa-5dea-4696-97f8-0d67dc8b5eba	6b8878a8-881c-457e-a56b-c1ebab8bed59	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjZiODg3OGE4LTg4MWMtNDU3ZS1hNTZiLWMxZWJhYjhiZWQ1OSIsImVtYWlsIjpudWxsLCJyb2xlIjoiY3VzdG9tZXIiLCJpYXQiOjE3NTM1NDM0NzksImV4cCI6MTc1NDE0ODI3OX0.1L3em4Taz1R5IOi7-H3O3TYhA0bE-1800groNmQHWCY	2025-08-02 15:24:39.91596+00	2025-07-26 15:24:39.91596+00
...
5aeb089a-ccb2-4a41-b32d-7919a36e1903	59d2f833-a118-4a43-a1d1-73a7f5119ddf	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5ZDJmODMzLWExMTgtNGE0My1hMWQxLTczYTdmNTExOWRkZiIsImVtYWlsIjoid2ludXQuaGZAZ21haWwuY29tIiwicm9sZSI6InN1cGVyX2FkbWluIiwiaWF0IjoxNzUzNjM1NDM1LCJleHAiOjE3NTQyNDAyMzV9.ZAABj01lKJI3DrdYRKAD49Yw9T7OHo2HJwUgOQ4w6Fo	2025-08-03 16:57:15.623358+00	2025-07-27 16:57:15.623358+00
...
5897f5ad-d36e-4e2c-8fcd-18ac26c7bca8	59d2f833-a118-4a43-a1d1-73a7f5119ddf	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5ZDJmODMzLWExMTgtNGE0My1hMWQxLTczYTdmNTExOWRkZiIsImVtYWlsIjoid2ludXQuaGZAZ21haWwuY29tIiwicm9sZSI6InN1cGVyX2FkbWluIiwiaWF0IjoxNzUzNjM3NjY4LCJleHAiOjE3NTQyNDI0Njh9.0KYPg8qGcWj6Zdarowhy6-r6JACCncOCs1zDH44hIXU	2025-08-03 17:34:28.891284+00	2025-07-27 17:34:28.891284+00
...
35c04f19-7a8a-4249-92e4-e0af014c4319	6b8878a8-881c-457e-a56b-c1ebab8bed59	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjZiODg3OGE4LTg4MWMtNDU3ZS1hNTZiLWMxZWJhYjhiZWQ1OSIsImVtYWlsIjpudWxsLCJyb2xlIjoiY3VzdG9tZXIiLCJpYXQiOjE3NTM1NDc2MjksImV4cCI6MTc1NDE1MjQyOX0.1XqZmBA9pou2tylvQ2BcJL3YVws1BBkPTQLvutX9vrQ	2025-08-02 16:33:49.42487+00	2025-07-26 16:33:49.42487+00
...
0b11df31-06af-46de-b83a-ed498e7ad7a8	59d2f833-a118-4a43-a1d1-73a7f5119ddf	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5ZDJmODMzLWExMTgtNGE0My1hMWQxLTczYTdmNTExOWRkZiIsImVtYWlsIjoid2ludXQuaGZAZ21haWwuY29tIiwicm9sZSI6InN1cGVyX2FkbWluIiwiaWF0IjoxNzUzNjE0MjMyLCJleHAiOjE3NTQyMTkwMzJ9.r7vI4c1cTph1bSqQuNdpYmXO2ixKUcsj9uBIKrZLVJA	2025-08-03 11:03:52.282583+00	2025-07-27 11:03:52.282583+00
...
--
-- Data for Name: survey_translations; Type: TABLE DATA; Schema: public; Owner: loyalty
--

COPY public.survey_translations (id, survey_id, language, title, description, questions, created_at, updated_at) FROM stdin;
8e16079c-de97-43b5-ab15-d69d0c79b0af	b5cbde95-7faf-4268-b3e3-7047a1e4e17b	th	แบบสํารวจการทดสอบสาธารณะ	นี่คือแบบสํารวจสาธารณะสําหรับการทดสอบหน้าแบบสํารวจ	[{"id": "q_1", "text": "คุณพอใจกับบริการของเราแค่ไหน?", "type": "single_choice", "order": 1, "options": [{"id": "opt_1", "text": "พอใจมาก", "value": 5}, {"id": "opt_2", "text": "พอใจ", "value": 4}, {"id": "opt_3", "text": "เป็นกลาง", "value": 3}, {"id": "opt_4", "text": "ไม่พอใจ", "value": 2}, {"id": "opt_5", "text": "ไม่พอใจมาก", "value": 1}], "required": true}, {"id": "q_2", "text": "โปรดให้ข้อเสนอแนะเพิ่มเติม", "type": "text", "order": 2, "required": false}]	2025-07-27 16:38:14.364086+00	2025-07-27 16:38:14.364086+00
\.
...
COPY public.surveys (id, title, description, questions, target_segment, status, scheduled_start, scheduled_end, created_by, created_at, updated_at, access_type, original_language, available_languages, last_translated, translation_status) FROM stdin;
49d50c45-b235-4e77-a952-4b53edce213a	ทดสอบ		[{"id": "q_mkavo7y2x", "text": "คำถามทดสอบ", "type": "single_choice", "order": 1, "options": [{"id": "opt_u0wrdz69p", "text": "Option 1", "value": "option1"}, {"id": "opt_saf3lltfa", "text": "Option 2", "value": "option2"}], "required": true}]	{}	active	\N	\N	\N	2025-07-22 22:19:06.337292	2025-07-22 22:19:20.131208	public	th	["th"]	\N	none
b5cbde95-7faf-4268-b3e3-7047a1e4e17b	Public Test Survey	This is a public survey for testing the surveys page	[{"id": "q_1", "text": "How satisfied are you with our service?", "type": "single_choice", "order": 1, "options": [{"id": "opt_1", "text": "Very Satisfied", "value": 5}, {"id": "opt_2", "text": "Satisfied", "value": 4}, {"id": "opt_3", "text": "Neutral", "value": 3}, {"id": "opt_4", "text": "Dissatisfied", "value": 2}, {"id": "opt_5", "text": "Very Dissatisfied", "value": 1}], "required": true}, {"id": "q_2", "text": "Please provide any additional feedback", "type": "text", "order": 2, "required": false}]	{}	active	\N	\N	\N	2025-07-22 22:26:31.115699	2025-07-22 22:26:31.115699	public	th	["th"]	\N	none
5eb4165b-7e38-439c-9936-db47b454a7e5	Customer Satisfaction Survey	Tell us about your experience with our hotel services	[{"id": "q_rating", "text": "How would you rate your overall experience?", "type": "rating_5", "order": 1, "required": true}, {"id": "q_recommend", "text": "Would you recommend us to others?", "type": "yes_no", "order": 2, "required": true}]	{}	active	\N	\N	\N	2025-07-22 22:26:31.1167	2025-07-22 22:26:31.1167	public	th	["th"]	\N	none
c5824262-bcba-489e-ab48-5c720ff3dbb4	Service Quality Assessment	Help us improve our service quality	[{"id": "q_service_rating", "text": "Rate the quality of our customer service (1-10)", "type": "rating_10", "order": 1, "required": true}]	{}	active	\N	\N	\N	2025-07-22 22:26:31.117371	2025-07-22 22:26:31.117371	public	th	["th"]	\N	none
279b0dd1-26cc-4054-a792-1948d6769204	Test Active Survey Creation	Testing that status is properly set	[{"id": "q1", "text": "Test question", "type": "single_choice", "order": 1, "options": [{"id": "opt1", "text": "Option 1", "value": "1"}, {"id": "opt2", "text": "Option 2", "value": "2"}], "required": true}]	{}	active	\N	\N	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-22 22:45:07.275871	2025-07-22 22:45:07.275871	invite_only	th	["th"]	\N	none
35b6cf9c-b935-45be-9d29-92f1d14045d6	ทดสอบ invite survey		[{"id": "q_o62xuqk5o", "text": "test", "type": "single_choice", "order": 1, "options": [{"id": "opt_4mwqsgf7c", "text": "Option 1", "value": "option1"}, {"id": "opt_owq8f38lt", "text": "Option 2", "value": "option2"}], "required": true}]	{}	active	\N	\N	59d2f833-a118-4a43-a1d1-73a7f5119ddf	2025-07-22 22:37:42.634633	2025-07-22 23:08:52.392853	invite_only	th	["th"]	\N	none
...
e80a9db0-edff-47a2-9eac-57aeb973055a	Translation Test Survey	Testing coupon assignment translations	[{"id": "q1", "text": "How do you rate our service?", "type": "single_choice", "order": 1, "options": [{"id": "opt1", "text": "Excellent", "value": "5"}, {"id": "opt2", "text": "Good", "value": "4"}], "required": true}]	{}	active	\N	\N	\N	2025-07-23 16:01:07.744077	2025-07-23 16:01:07.744077	public	th	["th"]	\N	none
b85b76a7-b420-4068-900b-d166f9dc2cea	Translation Test Survey	Testing coupon assignment translations	[{"id": "q1", "text": "How do you rate our service?", "type": "single_choice", "order": 1, "options": [{"id": "opt1", "text": "Excellent", "value": "5"}, {"id": "opt2", "text": "Good", "value": "4"}], "required": true}]	{}	active	\N	\N	\N	2025-07-23 16:01:34.075415	2025-07-23 16:01:34.075415	public	th	["th"]	\N	none
dab7788a-eb97-4e76-a0ae-6a1fb1f22fae	Translation Test Survey	Testing coupon assignment translations	[{"id": "q1", "text": "How do you rate our service?", "type": "single_choice", "order": 1, "options": [{"id": "opt1", "text": "Excellent", "value": "5"}, {"id": "opt2", "text": "Good", "value": "4"}], "required": true}]	{}	active	\N	\N	\N	2025-07-23 16:01:42.069564	2025-07-23 16:01:42.069564	public	th	["th"]	\N	none
...
2ef6d5f2-39a1-4dcf-861c-7ae671a1491e	Translation Test Survey	Testing coupon assignment translations	[{"id": "q1", "text": "How do you rate our service?", "type": "single_choice", "order": 1, "options": [{"id": "opt1", "text": "Excellent", "value": "5"}, {"id": "opt2", "text": "Good", "value": "4"}], "required": true}]	{}	active	\N	\N	\N	2025-07-23 16:02:00.030373	2025-07-27 16:40:38.993752	public	th	["th"]	\N	none
\.
...
--
-- Data for Name: translation_jobs; Type: TABLE DATA; Schema: public; Owner: loyalty
--

COPY public.translation_jobs (id, entity_type, entity_id, source_language, target_languages, status, progress, characters_translated, provider, error, created_by, created_at, updated_at, completed_at) FROM stdin;
abaa85e8-8a72-4362-ae22-b1160bd6fc86	survey	b5cbde95-7faf-4268-b3e3-7047a1e4e17b	en	["th"]	failed	0	0	azure	Unexpected token o in JSON at position 1	\N	2025-07-27 16:37:04.24556+00	2025-07-27 16:37:04.26057+00	\N
81126830-19a1-43ab-bba9-169f2d567275	survey	b5cbde95-7faf-4268-b3e3-7047a1e4e17b	en	["th"]	completed	100	206	azure	\N	\N	2025-07-27 16:38:13.965964+00	2025-07-27 16:38:14.368822+00	2025-07-27 16:38:14.368+00
\.
...
f613e669-88b1-4fe8-9968-dc6a3d744a81	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": true}	\N	\N	2025-07-23 11:49:21.374469+00
...
857e71a3-5bdc-4ef6-95c8-005056d7a937	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 07:36:20.863077+00
...
b8b14b19-a29d-4949-a6f8-fd1ed3a686d4	\N	logout	{}	\N	\N	2025-07-24 07:36:45.244762+00
...
d318df8b-2228-4599-9625-6922147371dd	59d2f833-a118-4a43-a1d1-73a7f5119ddf	logout	{}	\N	\N	2025-07-26 14:07:52.694397+00
2567c329-cc20-4df8-b8f8-fbb0c17e3856	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 21:57:44.821572+00
527832da-1e40-49c8-83ba-76080e3fe496	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 22:24:01.230414+00
af983af9-880a-4710-b676-466a5ec90233	\N	logout	{}	\N	\N	2025-07-24 22:24:02.813522+00
12cc5de8-0b25-4595-a273-a5e4ddd5106e	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 22:30:43.366224+00
f727818a-ffc7-4eb5-bdee-db38e93ed1de	\N	logout	{}	\N	\N	2025-07-24 22:30:51.461725+00
2c4a5118-dfac-4ddb-8ece-fc807ecd6d2c	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 23:43:54.785608+00
61f506df-a087-4f95-8631-9a13b3caa4a3	\N	logout	{}	\N	\N	2025-07-24 23:43:57.152203+00
a5da61d4-f928-4e01-a682-fe10a74cb97d	\N	logout	{}	\N	\N	2025-07-25 01:05:27.535475+00
68a1103f-3ed6-4716-b3fd-e78c8a9a00ee	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-25 09:09:40.768614+00
8d3e4208-84cc-4481-9b30-3431f104b3eb	\N	logout	{}	\N	\N	2025-07-25 16:31:55.73023+00
1a654d28-deaa-4fba-9d3d-a20b270d57b3	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-26 14:08:21.271439+00
aa80e572-a69f-4ac7-9264-71db5b279d5c	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-24 22:27:34.889239+00
a1274b74-8ffb-492c-aa92-d07f5327c100	\N	logout	{}	\N	\N	2025-07-24 22:27:45.303285+00
8d7f4e05-c869-4b8a-8336-aa0a755e45bd	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-25 00:07:40.863244+00
5402f396-af83-40ae-a551-d463a4f351f7	\N	logout	{}	\N	\N	2025-07-25 09:09:48.328143+00
...
9754680a-be55-464f-83f0-3f2e557a038b	59d2f833-a118-4a43-a1d1-73a7f5119ddf	oauth_login	{"provider": "google", "isNewUser": false}	\N	\N	2025-07-26 14:07:33.021168+00
ff8a0464-4326-4707-bc67-37b92728d670	59d2f833-a118-4a43-a1d1-73a7f5119ddf	oauth_login	{"provider": "google", "isNewUser": false}	\N	\N	2025-07-26 14:24:59.949237+00
9c009958-be2b-4ccf-8313-dec5cbce3cf7	\N	logout	{}	\N	\N	2025-07-24 21:57:53.455392+00
ae0dcd0d-423d-4665-98f2-63b746b8e521	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-25 16:30:46.021066+00
a98bf5e1-75e7-4185-add0-a9ced8a9c0ae	\N	logout	{}	\N	\N	2025-07-26 14:24:55.006869+00
ceb2db2b-caf1-4eb4-b711-ef5fa279782c	59d2f833-a118-4a43-a1d1-73a7f5119ddf	logout	{}	\N	\N	2025-07-26 14:25:13.219606+00
bcdfce5d-4fa7-4566-a79f-ce54a2872b0a	\N	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": true}	\N	\N	2025-07-26 14:25:18.783862+00
52a8b1cf-e313-4c0c-b477-1c002b7ee3c8	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": true}	\N	\N	2025-07-26 14:56:29.420841+00
65720c72-26fd-4aa1-8410-7c43d16a5afd	6b8878a8-881c-457e-a56b-c1ebab8bed59	logout	{}	\N	\N	2025-07-26 15:08:07.694874+00
429279a0-e8fd-4847-840f-976251804ef2	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-26 15:08:14.099246+00
33f24a74-0b3b-4b42-bba7-dbafbc6b577d	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-26 15:40:32.711617+00
f7ce9341-8c34-4790-b28c-42e482d2153b	6b8878a8-881c-457e-a56b-c1ebab8bed59	logout	{}	\N	\N	2025-07-26 15:41:23.558457+00
53cab06f-dfa9-4bfb-818e-f675c1066438	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-26 15:41:28.946358+00
5acdda8e-01f3-403c-b159-87f9263418f9	6b8878a8-881c-457e-a56b-c1ebab8bed59	logout	{}	\N	\N	2025-07-26 15:52:48.01722+00
f9ca6383-3883-4141-adee-ab6f75f68df8	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-26 15:52:54.285256+00
1c9d9cdd-8c5c-42ef-ad0c-ab495443413c	6b8878a8-881c-457e-a56b-c1ebab8bed59	logout	{}	\N	\N	2025-07-26 16:33:49.436211+00
c680168b-b924-4adc-8def-5b716c3ba460	6b8878a8-881c-457e-a56b-c1ebab8bed59	oauth_login	{"lineId": "Ua7448f9eb068bb4c7d480e2f0aed3c21", "provider": "line", "isNewUser": false}	\N	\N	2025-07-27 06:19:49.159905+00
5d409455-aab9-4a2f-ab32-22ccc1dc41e2	6b8878a8-881c-457e-a56b-c1ebab8bed59	logout	{}	\N	\N	2025-07-27 06:28:17.958672+00
956621fd-2a23-406b-8f0b-f0c0a7a10a70	59d2f833-a118-4a43-a1d1-73a7f5119ddf	oauth_login	{"provider": "google", "isNewUser": false}	\N	\N	2025-07-27 06:42:10.06283+00
0a3301f6-286b-4f16-8b99-3582370453e6	59d2f833-a118-4a43-a1d1-73a7f5119ddf	oauth_login	{"provider": "google", "isNewUser": false}	\N	\N	2025-07-27 16:40:01.345748+00
6bebc2b8-48ba-4c17-b0ac-23c494fc3603	59d2f833-a118-4a43-a1d1-73a7f5119ddf	oauth_login	{"provider": "google", "isNewUser": false}	\N	\N	2025-07-27 16:57:22.232672+00
\.
...
6b8878a8-881c-457e-a56b-c1ebab8bed59	0	8a6a84a2-6b99-48cf-9c7d-fe6bc78ff7b1	2025-07-26 14:56:29.428617+00	2025-07-26 14:56:29.428617+00	2025-07-26 14:56:29.428617+00	2025-07-26 14:56:29.428617+00	0
\.
...
6b8878a8-881c-457e-a56b-c1ebab8bed59	นัท		\N	\N	{}	emoji:🧝	2025-07-26 14:56:29.414124+00	2025-07-27 06:19:49.141766+00	26900060
59d2f833-a118-4a43-a1d1-73a7f5119ddf	winut	j	333333333	1995-02-24	{}	/storage/avatars/59d2f833-a118-4a43-a1d1-73a7f5119ddf_avatar.jpg	2025-07-19 16:50:07.473601+00	2025-07-27 16:57:22.213755+00	26900081
\.
...
6b8878a8-881c-457e-a56b-c1ebab8bed59	\N		customer	t	f	2025-07-26 14:56:29.397582+00	2025-07-27 06:19:49.15353+00	line	Ua7448f9eb068bb4c7d480e2f0aed3c21
\.
...
--
-- Name: coupon_translations coupon_translations_coupon_id_language_key; Type: CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.coupon_translations
    ADD CONSTRAINT coupon_translations_coupon_id_language_key UNIQUE (coupon_id, language);


--
-- Name: coupon_translations coupon_translations_pkey; Type: CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.coupon_translations
    ADD CONSTRAINT coupon_translations_pkey PRIMARY KEY (id);
...
--
-- Name: survey_translations survey_translations_pkey; Type: CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.survey_translations
    ADD CONSTRAINT survey_translations_pkey PRIMARY KEY (id);


--
-- Name: survey_translations survey_translations_survey_id_language_key; Type: CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.survey_translations
    ADD CONSTRAINT survey_translations_survey_id_language_key UNIQUE (survey_id, language);
...
--
-- Name: translation_jobs translation_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: loyalty
--
...
--
-- Name: idx_coupon_translations_coupon_lang; Type: INDEX; Schema: public; Owner: loyalty
--

CREATE INDEX idx_coupon_translations_coupon_lang ON public.coupon_translations USING btree (coupon_id, language);
...
--
-- Name: idx_survey_translations_survey_lang; Type: INDEX; Schema: public; Owner: loyalty
--

CREATE INDEX idx_survey_translations_survey_lang ON public.survey_translations USING btree (survey_id, language);
...
--
-- Name: idx_translation_jobs_created_by; Type: INDEX; Schema: public; Owner: loyalty
--

CREATE INDEX idx_translation_jobs_created_by ON public.translation_jobs USING btree (created_by);


--
-- Name: idx_translation_jobs_entity; Type: INDEX; Schema: public; Owner: loyalty
--

CREATE INDEX idx_translation_jobs_entity ON public.translation_jobs USING btree (entity_type, entity_id);


--
-- Name: idx_translation_jobs_status; Type: INDEX; Schema: public; Owner: loyalty
--
...
--
-- Name: idx_users_email_unique; Type: INDEX; Schema: public; Owner: loyalty
--
...
--
-- Name: coupon_translations trigger_coupon_translations_updated_at; Type: TRIGGER; Schema: public; Owner: loyalty
--

CREATE TRIGGER trigger_coupon_translations_updated_at BEFORE UPDATE ON public.coupon_translations FOR EACH ROW EXECUTE FUNCTION public.update_translation_updated_at();
...
--
-- Name: survey_translations trigger_survey_translations_updated_at; Type: TRIGGER; Schema: public; Owner: loyalty
--

CREATE TRIGGER trigger_survey_translations_updated_at BEFORE UPDATE ON public.survey_translations FOR EACH ROW EXECUTE FUNCTION public.update_translation_updated_at();


--
-- Name: translation_jobs trigger_translation_jobs_updated_at; Type: TRIGGER; Schema: public; Owner: loyalty
--

CREATE TRIGGER trigger_translation_jobs_updated_at BEFORE UPDATE ON public.translation_jobs FOR EACH ROW EXECUTE FUNCTION public.update_translation_updated_at();
...
--
-- Name: coupon_translations coupon_translations_coupon_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.coupon_translations
    ADD CONSTRAINT coupon_translations_coupon_id_fkey FOREIGN KEY (coupon_id) REFERENCES public.coupons(id) ON DELETE CASCADE;
...
--
-- Name: survey_translations survey_translations_survey_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: loyalty
--
...
--
-- Name: translation_jobs translation_jobs_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: loyalty
--

ALTER TABLE ONLY public.translation_jobs
    ADD CONSTRAINT translation_jobs_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);
